...
import selectionsort from "../logics/selectionsortlogic";
        ...
        <div className="sorting-page-left">
          <div className="sorting-page-left-innerbox">
            ...
            <div className="sorting-page-headings">
              <p className="sorting-page-heading">Selection Sort</p>
  ...
  from the unsorted portion and placing it at the beginning.
            ...
            <div className="sorting-page-speed">
              ...
              <div className="speed-btn">
                <FontAwesomeIcon icon={fas.faPlay} onClick={() => animateSort(selectionsort)} className="speed-icons" />
