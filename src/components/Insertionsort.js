...
import insertionSort from "../logics/insertionsortlogic";
...
const animateSort = (getAnimations) => {
  ...
  setIsSorting(true);//avoids bugs on multiple clicking play btnt
        ...
        <div className="sorting-page-left">
          <div className="sorting-page-left-innerbox">
            ...
            <div className="sorting-page-headings">
              <p className="sorting-page-heading">Insertion Sort</p>
            ...
            <div className="sorting-page-speed">
              ...
              <div className="speed-btn">
                <FontAwesomeIcon icon={fas.faPlay} onClick={() => animateSort(insertionSort)} className="speed-icons" />
